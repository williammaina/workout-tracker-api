...
Revision ID: 3463ba660405
Revises: 
Create Date: 2026-07-27 11:11:20.627583
...
def upgrade():
    ...
    sa.CheckConstraint('duration_seconds IS NULL OR duration_seconds >= 0', name='check_duration_sec_non_negative'),
